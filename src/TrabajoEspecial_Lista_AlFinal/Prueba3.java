...
public class Prueba3 {
	...
	public static Lista_al_final reader (){
		Lista_al_final usuarios = new Lista_al_final();
		String csvFile = "/Users/JuaniForte/Desktop/datasets/dataset_3000000.csv";
		String line = "";
		String cvsSplitBy = ";";
	...
	public static void writterAlta(Lista_al_final usuarios){
	...
	public static void writterBusqueda(Lista_al_final usuarios){
	...
	public static void main(String[] args) {
		...
		Lista_al_final us = new Lista_al_final();
		us = reader();
		writterAlta(us);
		writterBusqueda(us);
	}
