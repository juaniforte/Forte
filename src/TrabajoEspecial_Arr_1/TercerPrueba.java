...
public class TercerPrueba {

	public static Arreglo reader (){
		Arreglo usuarios = new Arreglo();
	...
	public static void writterAlta(Arreglo usuarios){
	...
	public static void writterBusqueda(Arreglo usuarios){
